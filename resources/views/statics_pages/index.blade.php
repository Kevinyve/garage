                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">// ENTRETIEN AUTOMOBILE //</h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Centre de service de lavage de voiture qualifié</h1>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInDown">Pour en savoir plus<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <h6 class="text-primary text-uppercase">// Présentation //</h6>
                    <h1 class="mb-4"><span class="text-primary">CarServ</span> Est le meilleur endroit pour votre entretien automobile</h1>
                    ...
                    <a href="" class="btn btn-primary py-3 px-5">Lire la suite<i class="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="nav w-100 nav-pills me-4">
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-0" data-bs-toggle="pill" data-bs-target="#tab-pane-4" type="button">
                            ...
                            <h4 class="m-0">Vidange d’huile</h4>
                        </button>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="tab-content w-100">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb-3">15 ans d’expérience dans l’entretien automobile</h3>
                                    <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                                    ...
                                    <a href="" class="btn btn-primary py-3 px-5 mt-3">Lire la suite<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Réservez pour un service</h1>
                        <form>
                            <div class="row g-3">
